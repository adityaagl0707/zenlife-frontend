...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "What is ZenAge?",
        a: "ZenAge is your biological age — derived from the validated PhenoAge formula (9 blood biomarkers) plus an AI-driven synthesis across all your scan data. It returns five sub-ages: metabolic, vascular, bone & muscle, inflammation and kidney. A ZenAge lower than your chronological age means you're ageing slower; higher means faster.",
      },
      {
        q: "What are Health Priorities?",
        a: "Your top 3 things to act on this year, generated by our AI engine from your unique findings. Each priority comes with a tailored diet plan, exercise prescription, sleep recommendation and supplement protocol.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      {
        q: "What is Zeno?",
        a: "Zeno is your personal AI health assistant. Zeno has read your full ZenReport — every parameter, every organ score, your ZenAge and your Health Priorities — and can answer any question in plain English, 24/7 for 12 months after your scan.",
      },
      {
