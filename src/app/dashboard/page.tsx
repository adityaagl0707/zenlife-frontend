...
function SelfReportEntry({
  ...
  return (
    <article className="group grid grid-cols-[72px_1fr] gap-0 rounded-2xl overflow-hidden ring-2 ring-selfreport-200 transition-shadow hover:shadow-md">
      <div className="flex flex-col items-center justify-center gap-0.5 py-5 bg-selfreport-600 text-white">
        {dateParts ? (
          <>
      ...
      <div className="bg-selfreport-50/40 px-5 py-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-[10px] font-bold uppercase tracking-[0.18em] text-selfreport-700 bg-selfreport-100 rounded-full px-2 py-0.5">
                Self-uploaded
              </span>
              <span className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[11px] font-bold bg-white text-selfreport-700 ring-1 ring-selfreport-200">
            ...
            <div className="mt-2 h-1 w-full max-w-[180px] rounded-full bg-selfreport-100 overflow-hidden">
              <div className="h-full bg-selfreport-500 transition-all" style={{ width: `${pct}%` }} />
            </div>
          </div>
        </div>

        <div className="mt-4 flex items-center gap-2 border-t border-selfreport-100 pt-3 flex-wrap">
          <Link
            href={`/report/${reportId}`}
            className="inline-flex items-center gap-1.5 rounded-full bg-selfreport-600 px-4 py-2 text-[12px] font-bold text-white hover:bg-selfreport-700 transition-colors"
          >
          ...
          <Link
            href="/upload"
            className="inline-flex items-center gap-1.5 rounded-full border border-selfreport-200 bg-white px-3.5 py-2 text-[12px] font-semibold text-selfreport-700 hover:bg-selfreport-50 transition-colors"
          >
        ...
        {loading ? (
          ...
          <div className="mt-4 grid gap-6 lg:grid-cols-[1fr_220px]">
            <div className="space-y-4">
              ...
              <Link
                href="/upload"
                className="flex items-start gap-3 rounded-2xl border border-selfreport-200 bg-selfreport-50/40 px-5 py-4 hover:bg-selfreport-50 transition-colors group"
              >
                <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl bg-selfreport-600 text-white">
                  <Upload className="h-4 w-4" />
                </div>
                <div className="flex-1">
                  <p className="text-[13px] font-bold text-selfreport-900">Have older reports? Upload them</p>
                  <p className="mt-0.5 text-[12px] text-selfreport-700/80 leading-relaxed">
                ...
                <ChevronRight className="h-4 w-4 text-selfreport-400 group-hover:translate-x-0.5 transition-transform" />
              </Link>
          ...
          <div className="mt-2 grid gap-8 lg:grid-cols-[1fr_220px]">
            ...
            <div>
              ...
              <Link
                href="/upload"
                className="mb-5 flex items-start gap-3 rounded-2xl border border-selfreport-200 bg-selfreport-50/40 px-5 py-4 hover:bg-selfreport-50 transition-colors group"
              >
                <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl bg-selfreport-600 text-white">
                  <Upload className="h-4 w-4" />
                </div>
                <div className="flex-1">
                  <p className="text-[13px] font-bold text-selfreport-900">
